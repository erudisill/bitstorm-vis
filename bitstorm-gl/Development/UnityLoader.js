...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'bitstorm-gl.data';
    var REMOTE_PACKAGE_BASE = 'bitstorm-gl.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8574606;
      var PACKAGE_UUID = '236b5ccc-dc4a-41bc-b47b-72e7c6067dcd';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 21756, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(21756, 35548, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(35548, 200120, 0, 0).open('GET', '/level0');
    new DataRequest(200120, 200769, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(200769, 204625, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(204625, 211029, 0, 0).open('GET', '/resources.assets');
    new DataRequest(211029, 5068697, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(5068697, 6988881, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(6988881, 8486253, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8486253, 8546981, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(8546981, 8574606, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_bitstorm-gl.data');

    };
    Module['addRunDependency']('datafile_bitstorm-gl.data');
